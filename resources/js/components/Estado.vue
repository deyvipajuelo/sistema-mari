    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Estados de expediente
                    ...
                    <tr v-for="estado in arrayEstado" :key="estado.id">
                      <td>
                            ...
                            <template v-if="estado.condicion">
                                <button type="button" class="btn btn-danger btn-sm" @click="desactivarRegistro(estado.id)">
                                <i class="fa fa-trash"></i></button>
                            </template>
                            <template v-else>
                                <button type="button" class="btn btn-info btn-sm" @click="activarRegistro(estado.id)">
            ...
            <div class="modal-body">
              <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input  type="text"  v-model="nombre" class="form-control" placeholder="Ingrese un estado">
...
<script>
    export default {
        ...
        listarRegistro (page,buscar,criterio){
                let me=this;
                var url=me.ruta + '/estado?page=' + page+'&buscar='+buscar+'&criterio='+criterio;
                axios.get(url).then(function (response) {
                    var respuesta=response.data;
                    me.arrayEstado = respuesta.consultas.data;
        ...
        registrarRegistro(){
            ...
            let me = this;
            axios.post(me.ruta + '/estado/registrar',{
                'nombre': this.nombre
        ...
        actualizarRegistro(){
            ...
            let me = this;
            axios.put(me.ruta + '/estado/actualizar',{
                'nombre': this.nombre,
            ...
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/estado/desactivar',{
                            'id': id
        ...
        activarRegistro(id){
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/estado/activar',{
                            'id': id
        ...
        validarRegistro(){
            ...
            if(!this.nombre) this.errorMostrarMsjEstado.push("El nombre del Estado no puede estar vacio");
