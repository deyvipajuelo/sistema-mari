      ...
      <div class="container-fluid">
        <div class="row">
              ...
              <div class="small-box bg-info">
                ...
                <a href="#" @click="abrirFormulario(1)" class="small-box-footer">Abrir <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-3 col-6">
              <!-- small box -->
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  <h3>{{verificado}}P/{{expedientes}}E</h3>
                ...
                <a href="#" @click="abrirFormulario(3)" class="small-box-footer">Abrir <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-3 col-6">
              <!-- small box -->
              <div class="small-box bg-danger">
                ...
                <a href="#" @click="abrirFormulario(4)" class="small-box-footer">Abrir <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-3 col-6">
              <!-- small box -->
              <div class="small-box bg-secondary">
                <div class="inner">
                  <h3 >{{total_desarchivar}}</h3>

                  <p>Desarchivamiento</p>
                </div>
                <div class="icon">
...
import desarchivar from './Desarchivar.vue'
      ...
      components: {
        ...
        methods : {
            ...
            obtenerIngreso1(){
                ...
                var arrayT=[];
                var tot1=0;
                var url=me.ruta + '/ingreso/obtenerTotal2';
                axios.get(url).then(function (response) {
                   // console.log(response);
                    var respuesta=response.data;
                    arrayT = respuesta.consulta;
            ...
            obtenerExpediente(){
                ...
                var arrayT=[];
                var tot1=0;
                var url=me.ruta + '/expediente/obtenerTotal';
                axios.get(url).then(function (response) {
                   // console.log(response);
                    var respuesta=response.data;
                    arrayT = respuesta.consulta;
            ...
            obtenerDesarchivar(){
                ...
                var arrayT=[];
                var tot1=0;
                var url=me.ruta + '/desarchivar/obtenerTotal';
                axios.get(url).then(function (response) {
                   // console.log(response);
                    var respuesta=response.data;
                    arrayT = respuesta.consulta;
                    tot1 = arrayT[0]['total'];
                    me.total_desarchivar=tot1;
