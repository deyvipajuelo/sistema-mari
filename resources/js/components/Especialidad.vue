...
<script>
    export default {
        ...
        listarRegistro (page,buscar,criterio){
                let me=this;
                var url=me.ruta + '/especialidad?page=' + page+'&buscar='+buscar+'&criterio='+criterio;
        ...
        registrarRegistro(){
            ...
            let me = this;
            axios.post(me.ruta + '/especialidad/registrar',{
                'nombre': this.nombre
        ...
        actualizarRegistro(){
            ...
            let me = this;
            axios.put(me.ruta + '/especialidad/actualizar',{
                'nombre': this.nombre,
            ...
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/especialidad/desactivar',{
                            'id': id
        ...
        activarRegistro(id){
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/especialidad/activar',{
                            'id': id
