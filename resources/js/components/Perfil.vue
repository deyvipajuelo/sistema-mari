                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      <option value="nombre">Perfil</option>
                            ...
                            <tbody>
                                <tr v-for="perfil in arrayPerfil" :key="perfil.id">
                                    <td>
                                        ...
                                        <template v-if="perfil.condicion">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarPerfil(perfil.id)">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarPerfil(perfil.id)">
                                                <i class="fa fa-check"></i>
                                            </button>
                                        </template>
                                    </td>
                                    <td v-text="perfil.nombre"></td>
                                    
                                    <td>
                                        <div v-if="perfil.condicion">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input  type="text"  v-model="nombre" class="form-control" placeholder="Nombre de Perfil">
...
<script>
    export default {
        ...
        listarPerfil (page,buscar,criterio){
                let me=this;
                var url=me.ruta + '/perfil?page=' + page+'&buscar='+buscar+'&criterio='+criterio;
        ...
        registrarPerfil(){
            ...
            let me = this;
            axios.post(me.ruta + '/perfil/registrar',{
                'nombre': this.nombre
        ...
        actualizarPerfil(){
            ...
            let me = this;
            axios.put(me.ruta + '/perfil/actualizar',{
                'nombre': this.nombre,
            ...
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/perfil/desactivar',{
                            'id': id
        ...
        activarPerfil(id){
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/perfil/activar',{
                            'id': id
        ...
        validarPerfil(){
            ...
            if(!this.nombre) this.errorMostrarMsjPerfil.push("El nombre delmperfil no puede estar vacio");
