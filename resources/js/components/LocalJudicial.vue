    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Local
            ...
            <div class="modal-body">
              <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                       <select class="form-control" v-model="idpjudicial">
                                           <option value="0" disabled>Seleccione</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input  type="text"  v-model="nombre" class="form-control" placeholder="Ingrese local">
...
<script>
    export default {
        ...
        listarRegistro (page,buscar,criterio){
                let me=this;
                var url=me.ruta + '/ljudicial?page=' + page+'&buscar='+buscar+'&criterio='+criterio;
        ...
        registrarRegistro(){
            ...
            let me = this;
            axios.post(me.ruta + '/ljudicial/registrar',{
        ...
        actualizarRegistro(){
            ...
            let me = this;
            axios.put(me.ruta + '/ljudicial/actualizar',{
                'idpjudicial': this.idpjudicial,
                'nombre': this.nombre,
                'direccion': this.direccion,
            ...
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/ljudicial/desactivar',{
                            'id': id
        ...
        activarRegistro(id){
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/ljudicial/activar',{
                            'id': id
        ...
        validarRegistro(){
            ...
            if(this.idpjudicial==0) this.errorMostrarMsjRegistro.push("Seleccione una provincia");
