            ...
            <div class="modal-body">
              <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                       <select class="form-control" v-model="iddjudicial">
...
<script>
    export default {
        ...
        listarRegistro (page,buscar,criterio){
                let me=this;
                var url=me.ruta + '/pjudicial?page=' + page+'&buscar='+buscar+'&criterio='+criterio;
        ...
        registrarRegistro(){
            ...
            let me = this;
            axios.post(me.ruta + '/pjudicial/registrar',{
        ...
        actualizarRegistro(){
            ...
            let me = this;
            axios.put(me.ruta + '/pjudicial/actualizar',{
                'iddjudicial': this.iddjudicial,
                'nombre': this.nombre,
            ...
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/pjudicial/desactivar',{
                            'id': id
        ...
        activarRegistro(id){
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/pjudicial/activar',{
                            'id': id
        ...
        validarRegistro(){
            ...
            if(this.iddjudicial==0) this.errorMostrarMsjRegistro.push("Seleccione un distrito judicial");
