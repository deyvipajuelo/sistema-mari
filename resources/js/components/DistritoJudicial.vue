    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Distrito Judicial
            ...
            <div class="card-body">
               <div class="form-group row">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody v-if="arrayRegistro.length">
                    <tr v-for="registro in arrayRegistro" :key="registro.id">
                      <td>
                            <button type="button" @click="abrirModal('modal','actualizar',registro)" class="btn btn-warning btn-sm">
                            <i class="fa fa-pencil"></i></button> &nbsp;
                            <template v-if="registro.condicion">
                                <button type="button" class="btn btn-danger btn-sm" @click="desactivarRegistro(registro.id)">
                                <i class="fa fa-trash"></i></button>
                            </template>
                            <template v-else>
                                <button type="button" class="btn btn-info btn-sm" @click="activarRegistro(registro.id)">
                                <i class="icon-check"></i></button>
                            </template>
                        </td>
                        <td v-text="registro.nombre"></td>
                        <td>
                            <div v-if="registro.condicion">
            ...
            <div class="modal-body">
              <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input  type="text"  v-model="nombre" class="form-control" placeholder="Ingrese especialidad">
...
<script>
    export default {
        ...
        listarRegistro (page,buscar,criterio){
                let me=this;
                var url=me.ruta + '/djudicial?page=' + page+'&buscar='+buscar+'&criterio='+criterio;
                axios.get(url).then(function (response) {
                    var respuesta=response.data;
                    me.arrayRegistro = respuesta.consultas.data;
        ...
        registrarRegistro(){
            ...
            let me = this;
            axios.post(me.ruta + '/djudicial/registrar',{
                'nombre': this.nombre
        ...
        actualizarRegistro(){
            ...
            let me = this;
            axios.put(me.ruta + '/djudicial/actualizar',{
                'nombre': this.nombre,
            ...
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/djudicial/desactivar',{
                            'id': id
        ...
        activarRegistro(id){
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/djudicial/activar',{
                            'id': id
        ...
        validarRegistro(){
            ...
            if(!this.nombre) this.errorMostrarMsjRegistro.push("Nombre de distrito judicial no puede estar vacio");
