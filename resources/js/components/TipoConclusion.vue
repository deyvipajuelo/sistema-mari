    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Tipo Conclusión
...
<script>
    export default {
        ...
        listarRegistro (page,buscar,criterio){
                let me=this;
                var url=me.ruta + '/tconclusion?page=' + page+'&buscar='+buscar+'&criterio='+criterio;
        ...
        registrarRegistro(){
            ...
            let me = this;
            axios.post(me.ruta + '/tconclusion/registrar',{
                'nombre': this.nombre
        ...
        actualizarRegistro(){
            ...
            let me = this;
            axios.put(me.ruta + '/tconclusion/actualizar',{
                'nombre': this.nombre,
            ...
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/tconclusion/desactivar',{
                            'id': id
        ...
        activarRegistro(id){
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/tconclusion/activar',{
                            'id': id
