    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Tipo Expediente
            ...
            <div class="modal-body">
              <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input  type="text"  v-model="nombre" class="form-control" placeholder="Ingrese tipo de expediente">
...
<script>
    export default {
        ...
        listarRegistro (page,buscar,criterio){
                let me=this;
                var url=me.ruta + '/texpediente?page=' + page+'&buscar='+buscar+'&criterio='+criterio;
        ...
        registrarRegistro(){
            ...
            let me = this;
            axios.post(me.ruta + '/texpediente/registrar',{
                'nombre': this.nombre
        ...
        actualizarRegistro(){
            ...
            let me = this;
            axios.put(me.ruta + '/texpediente/actualizar',{
                'nombre': this.nombre,
            ...
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/texpediente/desactivar',{
                            'id': id
        ...
        activarRegistro(id){
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    ...
                    if (result.isConfirmed) {
                        let me = this;
                        axios.put(me.ruta + '/texpediente/activar',{
                            'id': id
        ...
        validarRegistro(){
            ...
            if(!this.nombre) this.errorMostrarMsjTipo.push("El Tipo de Expediente no puede estar vacio");
