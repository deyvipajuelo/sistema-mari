...
<body>
    <div class="portada">
        ...
        <div>
            ...
            <p class="texto bloque-dos">Tengo el honor de dirigirme a usted y saludarle cordialmente, y en atención al documento de la referencia, remitirle adjunto <span class="queja">{{$registro->queja}}</span>, proceso seguido contra el quejado {{$registro->demandado}}, conforme ha sido solicitado por su Despacho.</p>
